...
mixin(Service.prototype, {
  ...
  json: function(method, path, data, options,method) {
    return json(this._url(path), data, this._withDefaults(options), method);
  },
  postJson: function(method, path, data, options) {
    return json(this._url(path), data, this._withDefaults(options), 'POST');
  },
  putJson: function(method, path, data, options) {
    return json(this._url(path), data, this._withDefaults(options), 'PUT');
  },
